...
Deno.test("symlinks-are-preserved-during-sync-forward", async (t) => {
  ...
  const testbed = await TestBed.create(t, {
    ...
    files: [
      ...
      `user:user | 0777 | source/symlink-absolute.txt -> ${testDir}target/file.txt`,
      `user:user | 0777 | source/symlink-relative.txt -> file.txt`,
      `user:user | 0777 | source/symlink-relative2.txt -> ./file.txt`,
  ...
  assertEquals(await testbed.readTestDir(), [
    ...
    `user:user | 0777 | target/symlink-absolute.txt -> ${testDir}target/file.txt`,
    `user:user | 0777 | target/symlink-relative.txt -> file.txt`,
    `user:user | 0777 | target/symlink-relative2.txt -> ./file.txt`,
  ]);
});
...
Deno.test("symlinks-are-preserved-during-sync-backwards", async (t) => {
  ...
  const testbed = await TestBed.create(t, {
    ...
    files: [
      ...
      "user:user | 0755 | target/",
      "user:user | 0644 | target/file.txt | file content",
      `user:user | 0777 | target/symlink-absolute.txt -> ${testDir}source/file.txt`,
      `user:user | 0777 | target/symlink-relative.txt -> file.txt`,
      `user:user | 0777 | target/symlink-relative2.txt -> ./file.txt`,
    ],
  });
  ...
  assertEquals(await testbed.readTestDir(), [
    ...
    "user:user | 0755 | source/",
    "user:user | 0644 | source/file.txt | file content",
    `user:user | 0777 | source/symlink-absolute.txt -> ${testDir}source/file.txt`,
    `user:user | 0777 | source/symlink-relative.txt -> file.txt`,
    `user:user | 0777 | source/symlink-relative2.txt -> ./file.txt`,
    "user:user | 0755 | target/",
    "user:user | 0644 | target/file.txt | file content",
...
Deno.test("symlink-target-change-is-synced", async (t) => {
  ...
  const testbed = await TestBed.create(t, {
    ...
    files: [
      ...
      `user:user | 0644 | source/symlink.txt -> one.txt`,
  ...
  assertEquals(await testbed.readTestDir(), [
    ...
    "user:user | 0755 | source/",
    "user:user | 0644 | source/one.txt | first",
    "user:user | 0777 | source/symlink.txt -> two.txt",
    "user:user | 0644 | source/two.txt | second",
    "user:user | 0755 | target/",
    "user:user | 0644 | target/one.txt | first",
    "user:user | 0777 | target/symlink.txt -> two.txt",
